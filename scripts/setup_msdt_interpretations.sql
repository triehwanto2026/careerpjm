-- Setup MSDT Static Interpretations for Reporting
-- Run this in Supabase SQL Editor

-- First, get the MSDT instrument ID
-- You'll need to replace the instrument_id below with the actual ID from your database

-- Delete existing MSDT interpretations (optional - uncomment if you want to reset)
-- DELETE FROM test_interpretations 
-- WHERE instrument_id = 'YOUR_MSDT_INSTRUMENT_ID';

-- Insert MSDT interpretations for each style at each level
-- Replace 'YOUR_MSDT_INSTRUMENT_ID' with the actual instrument ID
...
-- Democratic
('YOUR_MSDT_INSTRUMENT_ID', 'Democratic', 'Dominan', 7, 10, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Democratic', 'Menonjol', 5, 6, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Democratic', 'Situasional', 3, 4, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Democratic', 'Rendah', 0, 2, 
...
-- Executive
('YOUR_MSDT_INSTRUMENT_ID', 'Executive', 'Dominan', 10, 14, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Executive', 'Menonjol', 7, 9, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Executive', 'Situasional', 4, 6, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Executive', 'Rendah', 0, 3, 
...
-- Autocratic
('YOUR_MSDT_INSTRUMENT_ID', 'Autocratic', 'Dominan', 12, 17, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Autocratic', 'Menonjol', 9, 11, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Autocratic', 'Situasional', 6, 8, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Autocratic', 'Rendah', 0, 5, 
...
-- Bureaucratic
('YOUR_MSDT_INSTRUMENT_ID', 'Bureaucratic', 'Dominan', 14, 20, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Bureaucratic', 'Menonjol', 10, 13, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Bureaucratic', 'Situasional', 5, 9, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Bureaucratic', 'Rendah', 0, 4, 
...
-- Developer
('YOUR_MSDT_INSTRUMENT_ID', 'Developer', 'Dominan', 10, 14, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Developer', 'Menonjol', 7, 9, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Developer', 'Situasional', 4, 6, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Developer', 'Rendah', 0, 3, 
...
-- Human Relations
('YOUR_MSDT_INSTRUMENT_ID', 'Human Relations', 'Dominan', 13, 18, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Human Relations', 'Menonjol', 9, 12, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Human Relations', 'Situasional', 5, 8, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Human Relations', 'Rendah', 0, 4, 
...
-- Compromiser
('YOUR_MSDT_INSTRUMENT_ID', 'Compromiser', 'Dominan', 15, 21, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Compromiser', 'Menonjol', 11, 14, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Compromiser', 'Situasional', 6, 10, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Compromiser', 'Rendah', 0, 5, 
...
-- Laissez Faire
('YOUR_MSDT_INSTRUMENT_ID', 'Laissez Faire', 'Dominan', 10, 14, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Laissez Faire', 'Menonjol', 7, 9, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Laissez Faire', 'Situasional', 4, 6, 
...
('YOUR_MSDT_INSTRUMENT_ID', 'Laissez Faire', 'Rendah', 0, 3, 
