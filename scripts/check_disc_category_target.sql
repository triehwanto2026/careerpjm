-- Check DISC test question options category_target values
-- This verifies that the category_target is correctly set for DISC questions
...
WHERE ti.name ILIKE '%disc%'
ORDER BY q.question_number, o.display_order;

-- Count options by category_target for DISC
SELECT 
  o.category_target,
  COUNT(*) as count
