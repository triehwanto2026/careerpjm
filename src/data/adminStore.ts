...
export const initialTestInstruments: TestInstrument[] = [
  ...
  },
  {
    ...
    description: "Tes penjumlahan deret angka untuk mengukur kecepatan kerja, ketelitian, ketahanan kerja, dan stabilitas emosi. Hasil berupa grafik kurva kerja.",
